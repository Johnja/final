...
public class GnrProject {
	...
	public GnrProject(long idgnrprj, String shortnamegnp, String name, String description, Date creationdate) {
		super();
	...
	public String toString() {
		return "Project[idgnrprj=" + idgnrprj + ", shortnamegnp=" + shortnamegnp + ", " + "name=" + name + ", description="
