...
public class ProjectRestController {
	...
	@RequestMapping("project/find/{idnprj}")
	@ResponseBody

	public Project getProject(@PathVariable("idnprj") long idnprj) throws NovaBKDaoException {
		...
		try {
			...
			if (!project.equals(null)) {
				...
				log.info("Log4j get the project with shortname ");
			}
		} catch (Exception e) {
	...
	@RequestMapping(method = RequestMethod.PUT, path = "project/edit/{idnprj}")
	@ResponseBody

	public void editProject(@PathVariable("idnprj") long idnprj, @RequestBody Project project) throws NovaBKRestException {
