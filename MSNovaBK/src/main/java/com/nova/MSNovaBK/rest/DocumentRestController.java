...
public class DocumentRestController {
	...
	@RequestMapping("document/find/{idndocument}")
	@ResponseBody

	public Document getDocument(@PathVariable("idndocument") long idndocument) throws NovaBKDaoException {
	...
	@RequestMapping(method = RequestMethod.PUT, path = "document/edit/{idndocument}")
	@ResponseBody

	public void editDocument(@PathVariable("idndocument") long idndocument, @RequestBody Document document) throws NovaBKRestException {
