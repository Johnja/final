...
public class GnrProjectRestController {
	...
	@RequestMapping("gnrproject/find/{idgnrprj}")
	@ResponseBody

	public GnrProject getGnrProject(@PathVariable("idgnrprj") long idgnrprj) throws NovaBKDaoException {
		...
		try {
			...
			if (!gnrProject.equals(null)) {
				...
				log.info("Log4j get the general project with shortname ");
			}
		} catch (Exception e) {
	...
	@RequestMapping(method = RequestMethod.PUT, path = "gnrproject/edit/{idgnrprj}")
	@ResponseBody

	public void editGnrProject(@PathVariable("idgnrprj") long idgnrprj, @RequestBody GnrProject gnrProject) throws NovaBKRestException {
